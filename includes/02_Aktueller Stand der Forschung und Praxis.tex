...
A Hopfield Network is also an \ac{EBM} and belongs to the field of recurrent neural networks.\footcite[Vgl.][35]{dramschChapterOne702020}
...
The connections between the neurons are symmetrical, which means that the weights of the connections are them same in either direction.\footcite[Vgl.][7]{ahadNeuralNetworksWireless2016}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\linewidth]{graphics/Hopfield_Netzwerk.png}
...
equation 2.4. When comparing a Hopfield Network, they seek to achieve the effect of changing node activation
on the overall energy of the network but \ac{BM}s replace this with the
probability of a certain node being activated on the network energy.\footcite[Vgl.][7]{ahadNeuralNetworksWireless2016}


Dasselbe wie eine BM - Energiefunktion gleich und Zustände sind diesselbe (0 und 1)

Training von Hopfield Netzwerken - Hebbeian Learning (nicht relevant)
...
Relevant: Algorhitmus mit dem Mann Hopfield Netzwerke updated interessant, Update algorhitmus Nutzen zum trainieren
von einem RBM - Updaten der Zustände (0, 1) 
...
-> Wähle ein Neuron aus und Berechne Summe und vergleiche mit Bias, 
